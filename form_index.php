...
<header>
<nav id="navbar">
    <a href="#" class="brand"><img class="menu-logo img-logo" src="logo.JPG" alt=""></a>

    <ul class="dropdown">
        <li><a href="index.html">HOME</a></li>
        <li><a href="contact.html" class="active-navbar">Contact</a></li>
...
<!-- <div class="contact_content"> 
    ...
    <h3>HTML Form with PHP Processing Script</h3>
</div>-->
        </div>
    ...
    <div class="right contact-animation">
        <div class="circle-animation">
            <img class="globe" src="images/design-earth-space_23-2147926394.jpg" alt="">
            <div class="rocket">
